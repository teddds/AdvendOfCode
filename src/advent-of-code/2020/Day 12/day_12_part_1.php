...
class State {
	...
	private const DIRECTIONS = [
		Navigator::MOVE_EAST,
		Navigator::MOVE_WEST,
		Navigator::MOVE_NORTH,
		Navigator::MOVE_SOUTH,
	];
	...
	private const NORMAL_ORIENTATION = [
		Navigator::MOVE_LEFT => [
			Navigator::MOVE_EAST => Navigator::MOVE_NORTH,
			Navigator::MOVE_NORTH => Navigator::MOVE_WEST,
			Navigator::MOVE_WEST => Navigator::MOVE_SOUTH,
			Navigator::MOVE_SOUTH => Navigator::MOVE_EAST,
		],
		Navigator::MOVE_RIGHT => [
			Navigator::MOVE_EAST => Navigator::MOVE_SOUTH,
	...
	public function move(string $operation, int $value){
		switch($operation){
			case Navigator::MOVE_NORTH:
				$this->y += $value;
				break;
			case Navigator::MOVE_SOUTH:
				$this->y -= $value;
				break;
			case Navigator::MOVE_EAST:
				$this->x += $value;
				break;
			case Navigator::MOVE_WEST:
				$this->x -= $value;
